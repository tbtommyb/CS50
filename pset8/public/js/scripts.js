...
{
    var markerPosition = new google.maps.LatLng(parseFloat(place.latitude), parseFloat(place.longitude));
    var location = place.place_name + ", " + place.admin_code1;
    
    // Personal touch
    var icon = {
        url: "img/icon.gif",
        scaledSize: new google.maps.Size(50, 50), // scaled to half size
